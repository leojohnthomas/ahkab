...
Notice how the two transistors have the same if and a low ir (saturation). Channel length modulation (due to different drain voltages) explains for the discrepancy in Ids.
